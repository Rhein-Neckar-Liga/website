...
class SlimStatConfig {
	...
	var $db_username = 'alfsql1'; // The username used to access your database
	var $db_password = 'carreaudRgnS'; // The password used to access your database
	var $db_database = 'alfsql1'; // The database containing SlimStat’s tables
